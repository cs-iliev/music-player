...
<body>
    ...
    $artists = getMostPopularArtistsPerUser($link, $_SESSION['username']);

    echo "<h1>My most listened Artists</h1><div class='chart'>";
    ...
    $albums = getMostPopularAlbumsPerUser($link, $_SESSION['username']);

    echo "<h1>My most listened Albums</h1><div class='chart'>";
    ...
    echo "<h1>My most listened Songs</h1>";

    $songs = getMostPopularSongsPerUser($link, $_SESSION['username']);
